  ...
  return (
    <>
      {!isMobile ? (
        ...
        <>
          <header className="header header_type_mobile">
            <div className="header__name-container header__name-container_type_mobile">
              <div className="header__feather header__feather_type_mobile"></div>
              <p className="header__name header__name_type_mobile">
                Потапова <br /> Евгения Юрьевна
              </p>
            </div>
            <BurgerMenu />
